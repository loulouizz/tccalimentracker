      ...
      body: SafeArea(
        child: Center(
          child: Column(
            ...
            children: [
              Icon(Icons.person_add, size: 200, color: Colors.greenAccent[700],),
              SizedBox(height: 10,),
              ...
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Cadastrar", style: GoogleFonts.roboto(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18),)),
                  ),
                ),
              ),
            ],
